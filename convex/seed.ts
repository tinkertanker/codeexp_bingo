...
const SQUARES: SeedSquare[] = [
  ...
  { position: 9,  category: 'grey',   title: 'IG POST #BrainHack2026 #DSTA', description: 'Post a picture or story on Instagram with the #BrainHack2026 and #DSTA hashtags, then paste the link.', verificationKind: 'ig_url_mentor',         enforceColourDistinct: false },
