...
type ScreenTab = 'overview' | 'bingo' | 'photos'
...
function ScoreboardView() {
  ...
  const useFullWidth = activeTab === 'bingo' || activeTab === 'photos'
  ...
  return (
    <div className="relative min-h-screen w-full bg-black text-white overflow-hidden">
      ...
      <div
        ...
        style={{ gridTemplateColumns: useFullWidth ? '1fr' : '1.05fr 1fr' }}
      >
              ...
              <div className="space-y-4">
                {groups.map((g) => (
                  <div key={g.id}>
                    ...
                    <Leaderboard standings={g.rows} highlightTeamIds={winnerIds} onTeamClick={setSelectedStanding} hideStats />
                  </div>
                ))}
              </div>
            ) : (
              <Leaderboard standings={filtered} highlightTeamIds={winnerIds} onTeamClick={setSelectedStanding} hideStats />
            )}
          </div>
        </section>
