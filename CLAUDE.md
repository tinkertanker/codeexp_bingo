...
Any team QR can be used as an approached/scanned team at most 10 times **for blue squares only**. Red/orange squares have no per-team scan limit. This cap is enforced in `convex/completions.ts`.
